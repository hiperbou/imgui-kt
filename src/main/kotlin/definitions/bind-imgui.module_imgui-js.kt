...
external interface Module : EmscriptenModule {
    ...
    fun Begin(name: String, p_open: Any /* JsTuple<Boolean> */, flags: WindowFlags): Boolean
    fun End()
    fun BeginChild(id: String, size: Readonly<interface_ImVec2>, border: Boolean, flags: WindowFlags): Boolean
    fun BeginChild(id: ImGuiID, size: Readonly<interface_ImVec2>, border: Boolean, flags: WindowFlags): Boolean
    fun EndChild()
    ...
    fun BeginPopup(str_id: String, flags: WindowFlags): Boolean
    fun BeginPopupModal(name: String, p_open: Any /* JsTuple<Boolean> */, flags: WindowFlags): Boolean
    fun EndPopup()
    ...
    fun BeginTable(str_id: String, column: Number, flags: TableFlags, outer_size: interface_ImVec2, inner_width: Number): Boolean
    fun EndTable()
    ...
    fun BeginChildFrame(id: ImGuiID, size: Readonly<interface_ImVec2>, flags: WindowFlags): Boolean
    fun EndChildFrame()
...
external interface ModulePartial /*: Emscripten.EmscriptenModulePartial */{
    ...
    var StyleColorsClassic: ((dst: ImGuiStyle?) -> Unit)?
        get() = definedExternally
        set(value) = definedExternally
    var Begin: ((name: String, p_open: dynamic /* JsTuple<Boolean> */, flags: WindowFlags) -> Boolean)?
        get() = definedExternally
        set(value) = definedExternally
    var End: (() -> Unit)?
        get() = definedExternally
        set(value) = definedExternally
    var BeginChild: ((id: dynamic /* String | ImGuiID */, size: Readonly<interface_ImVec2>, border: Boolean, flags: WindowFlags) -> Boolean)?
        get() = definedExternally
        set(value) = definedExternally
    var EndChild: (() -> Unit)?
        get() = definedExternally
    ...
    var SetTooltip: ((fmt: String) -> Unit)?
        get() = definedExternally
        set(value) = definedExternally
    var BeginPopup: ((str_id: String, flags: WindowFlags) -> Boolean)?
        get() = definedExternally
        set(value) = definedExternally
    var BeginPopupModal: ((name: String, p_open: dynamic /* JsTuple<Boolean> */, flags: WindowFlags) -> Boolean)?
        get() = definedExternally
        set(value) = definedExternally
    var EndPopup: (() -> Unit)?
        get() = definedExternally
    ...
    var IsPopupOpen: ((str_id: String, flags: ImGuiPopupFlags) -> Boolean)?
        get() = definedExternally
        set(value) = definedExternally
    var BeginTable: ((str_id: String, column: Number, flags: TableFlags, outer_size: interface_ImVec2, inner_width: Number) -> Boolean)?
        get() = definedExternally
        set(value) = definedExternally
    var EndTable: (() -> Unit)?
        get() = definedExternally
    ...
    var GetStyleColorName: ((idx: ImGuiCol) -> String)?
        get() = definedExternally
        set(value) = definedExternally
    var BeginChildFrame: ((id: ImGuiID, size: Readonly<interface_ImVec2>, flags: WindowFlags) -> Boolean)?
        get() = definedExternally
        set(value) = definedExternally
